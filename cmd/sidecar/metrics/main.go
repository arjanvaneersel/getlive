...
import (
	...
	"github.com/arjanvaneersel/getlive/cmd/sidecar/metrics/internal/collector"
	"github.com/arjanvaneersel/getlive/cmd/sidecar/metrics/internal/publisher"
	"github.com/arjanvaneersel/getlive/cmd/sidecar/metrics/internal/publisher/expvar"
)
...
func main() {
	...
	var cfg struct {
		...
		Collect struct {
			From string `conf:"default:http://getlive-api:4000/debug/vars"`
		}
		Publish struct {
